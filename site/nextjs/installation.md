...
npm run dev
```
This command starts the Next.js server on [http://localhost:3000]() . Open this URL in your browser to see your newly configured Next.js application.
...
```bash
npm install @mui/material-nextjs @emotion/cache @emotion/react @emotion/styled --save
```
    ...
    <Stack spacing={2} sx={{ width: '100%', maxWidth: 800, margin: 'auto' }}>
      <Box sx={{ p: 2, border: '1px dashed grey' }}>
        ...
        <Typography variant="body1" gutterBottom>
          This is a simple page designed to showcase how to use the Stack and Box components
          from Material-UI. Enjoy navigating through our content and exploring what we have to offer!
        </Typography>
